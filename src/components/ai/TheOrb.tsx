        ...
        try {
            ...
            if (result.tool_calls) {
                for (const toolCall of result.tool_calls) {
                    ...
                    if ((toolCall as any).function.name === 'create_order') {
                    ...
                    else if ((toolCall as any).function.name === 'set_timer') {
                    ...
                    else if ((toolCall as any).function.name === 'set_reminder') {
                        setTimeout(() => {
                            if ("Notification" in window && Notification.permission === "granted") {
                    ...
                    else if ((toolCall as any).function.name === 'add_pantry_item') {
                        // Find item
