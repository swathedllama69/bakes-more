    ...
    <div class="content">
      ...
      <div class="order-details">
        ...
        <div class="detail-row">
          ...
          <span class="value">${order.delivery_date ? new Date(order.delivery_date).toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : 'Not specified'}</span>
        </div>
